    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="rounded-full border border-input bg-background px-5 py-2.5 text-sm font-semibold text-foreground hover:bg-muted"
          >
            Go home
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Licensed Kathmandu-based tour agency offering Himalayan treks, cultural tours and jungle safaris across Nepal." },
      { name: "author", content: "Woodapple Tours and Travel" },
      { property: "og:title", content: "Woodapple Tours and Travel" },
      { property: "og:description", content: "Experience Nepal with local experts. Treks, cultural tours and safaris from Kathmandu." },
